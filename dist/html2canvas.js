    ...
    ***************************************************************************** */
    ...
    var DocumentCloner = /** @class */ (function () {
        ...
        DocumentCloner.prototype.createCustomElementClone = function (node) {
            var clone = document.createElement('html2canvas-custom-element');
            copyCSSStyles(node.style, clone);
            if (typeof clone.attachShadow !== 'undefined')
        ...
        DocumentCloner.prototype.appendChildNode = function (clone, child, copyStyles, isInShadow) {
                ...
                if (isElementNode(child) && isSlotElement(child) && typeof child.assignedNodes === 'function') {
                    ...
                    if (assignedNodes.length) {
                        assignedNodes.forEach(function (assignedNode) {
                            return _this.appendChildNode(clone, assignedNode, copyStyles, false);
                        });
                    }
                }
                else {
